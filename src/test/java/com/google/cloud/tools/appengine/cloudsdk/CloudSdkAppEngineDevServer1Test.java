...
public class CloudSdkAppEngineDevServer1Test {
  ...
  public void testPrepareCommand_allFlags() throws Exception {
    ...
    configuration.setRuntime("java8");
    ...
    List<String> expectedFlags = ImmutableList.of("--address=host", "--port=8090",
        "--default_gcs_bucket=buckets", "--runtime=java8", "--allow_remote_shutdown",
    ...
    verify(devServer).checkAndWarnIgnored(configuration.getClearDatastore(), "clearDatastore");
