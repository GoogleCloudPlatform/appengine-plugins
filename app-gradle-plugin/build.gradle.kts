...
version = "2.8.4-SNAPSHOT" // {x-version-update:app-gradle-plugin:current}
...
dependencies {
  ...
  api("com.google.cloud.tools:appengine-plugins-core:0.13.4-SNAPSHOT") // {x-version-update:appengine-plugins-core:current}
