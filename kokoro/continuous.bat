...
google\gcloud.cmd components copy-bundled-python>>python_path.txt && SET /p CLOUDSDK_PYTHON=<python_path.txt && DEL python_path.txt
google\gcloud.cmd components update --quiet
google\gcloud.cmd components install app-engine-java --quiet
